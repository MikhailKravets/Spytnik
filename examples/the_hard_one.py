...
ff1 += layers.Dropout(layers.Tanh(28, 28), percentage=0.3)
ff1 += layers.Dropout(layers.Tanh(28, 7), percentage=0.3)
ff1 += layers.Linear(7, 0)
...
ff2 += layers.Dropout(layers.Sigmoid(28, 28), percentage=0.3)
ff2 += layers.Dropout(layers.Sigmoid(28, 7), percentage=0.3)
ff2 += layers.Linear(7, 0)
...
ff3 += layers.Dropout(layers.Sigmoid(28, 28), percentage=0.3)
ff3 += layers.Dropout(layers.Sigmoid(28, 7), percentage=0.3)
ff3 += layers.Linear(7, 0)
